  ...
  return (
    <section className="flex w-full mx-auto mt-5">
      ...
      <div className="w-1/2 flex-none">
        <Img className="object-cover -mt-6 mb-2" fadeIn={false} fluid={data.fileName.childImageSharp.fluid}></Img>
      </div>
    </section>
  )
}
      ...
      <div className="flex justify-between container mx-auto mt-3 mb-3">
        <div className="w-1/2">
          ...
          <p className="text-2xl">
            When you add a track on one device, duotonic updates for
