...
const Header = ({ device, deviceSearching, room, setRoom, wsClient, error }) => {
  ...
  const connectedIcon = () => {
    if (error) return <DisconnectedIndicator />
    else if (deviceSearching) {
...
const DisconnectedIndicator = () => {
  return (
    <TriangleTooltip label="there was an error">
