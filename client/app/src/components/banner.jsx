...
export default function Banner({ setHideCookieBanner }) {
    ...
    return (
        <div className="inline-flex space-x-2 items-center justify-center bg-primary rounded text-white text-lg px-4">
            ...
            <button onClick={onClick} className="py-2">
                <svg className="fill-current h-6 w-6 text-text hover:text-red-500" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    <title>Close</title>
