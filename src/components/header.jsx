...
const Header = () => {
    return (
        <nav className="flex items-center justify-between flex-wrap bg-gray-800 p-4 border-b-2 border-gray-500">
            <div className="text-customgreen mr-6 mt-1">
                <span className="font-mono text-xl tracking-tight">pass the aux</span>
            </div>
            <div className="block lg:hidden">
                <button type="button" className="flex items-center px-3 py-2 border rounded text-white border-white hover:text-customgreen hover:border-customgreen">
